...
export class Config {
  ...
  'jhipster.mail.from' = 'troy@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'troy API';
  'jhipster.swagger.description' = 'troy API documentation';
  ...
  'eureka.instance.appname' = 'troy';
  'eureka.instance.instanceId' = 'troy:${random.value}';
